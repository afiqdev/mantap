...
# (C) Copyright 2021-2022 By GeoVPN
# =========================================
...
wget -q -O /etc/nginx/conf.d/duniavpn.conf "https://${Server_URL}/mantap/duniavpn.conf"
...
wget -q -O /etc/${Auther}/banner.txt "https://${Server_URL}/mantap/issue.net"
chmod +x /etc/${Auther}/banner.txt

# // Installing Dropbear
apt install dropbear -y
wget -O /etc/default/dropbear https://vpnkuy.site/mantap/dropbear.conf && chmod +x /etc/default/dropbear && cd /etc/default && apt install -y dos2unix && dos2unix dropbear
