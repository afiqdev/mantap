...
CLIENT_001=$( grep -c -E "^#DEPAN " "/etc/xray-mini/vless-nontls.json" )
echo "    =================================================="
echo "               LIST VLESS CLIENT ON THIS VPS"
echo "    =================================================="
grep -e "^#DEPAN " "/etc/xray-mini/vless-nontls.json" | cut -d ' ' -f 2-8 | nl -s ') '
...
user=$( grep -E "^#DEPAN " "/etc/xray-mini/vless-nontls.json" | cut -d ' ' -f 4 | sed -n "${CLIENT_002}"p)
exp=$( grep -E "^#DEPAN " "/etc/xray-mini/vless-nontls.json" | cut -d ' ' -f 8 | sed -n "${CLIENT_002}"p)
...
sed -i "s/#DEPAN Username : $user | Expired : $exp/#DEPAN Username : $user | Expired : $exp4/g" /etc/xray-mini/vless-nontls.json
sed -i "s/#DEPAN Username : $user | Expired : $exp/#DEPAN Username : $user | Expired : $exp4/g" /etc/xray-mini/vless-tls.json
sed -i "s/#BELAKANG Username : $user | Expired : $exp/#BELAKANG Username : $user | Expired : $exp4/g" /etc/xray-mini/vless-nontls.json
sed -i "s/#BELAKANG Username : $user | Expired : $exp/#BELAKANG Username : $user | Expired : $exp4/g" /etc/xray-mini/vless-tls.json
